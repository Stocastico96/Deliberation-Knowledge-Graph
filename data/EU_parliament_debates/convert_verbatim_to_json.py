#!/usr/bin/env python3
"""
Script to convert European Parliament verbatim HTML files to JSON format
...
def parse_verbatim_html(html_file):
    """Parse the verbatim HTML file and convert to JSON structure"""
...
def main():
    parser = argparse.ArgumentParser(description='Convert EP verbatim HTML to JSON')
    ...
    try:
        debate_json = parse_verbatim_html(args.input_file)
